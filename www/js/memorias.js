    ...
    function (tx, dados) {
      ...
      if (linhas == 0) {
        ...
        $(".item-link").on("click", function () {
          ...
          //FOCAR NO CAMPO INPUT RESCRITA
          $("#input_rescrita").focus();
        });

        // SAIU DO FOCA DO CAMPO INPUT R ESCRITA
...
$("#apagarMemorias").on("click", function () {
  app.dialog.confirm(
    "Tem certeza que deseja apagar as memórias?",
